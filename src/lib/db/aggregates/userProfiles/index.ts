...
/**
 * users・userStatusLogs・officialArenaStats・userRadarCache・userRoles・follows・statsPrivacy等を
 * 横断してユーザー向けの複合ビュー（おすすめ一覧・検索・ランキング・プロフィール等）を組み立てるリポジトリクラス。
 */
...
export const userProfilesRepo = new UserProfilesRepository();
