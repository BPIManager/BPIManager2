export const newBpiTranslations = {
  ...
  "newBpi.sort.currentBpiDesc": {
    ja: "V1 BPIが高い順",
    en: "V1 BPI (high to low)",
    "zh-TW": "依V1 BPI由高到低",
    ko: "V1 BPI 높은 순",
  },
  "newBpi.sort.newBpiDesc": {
    ja: "V2 BPIが高い順",
    en: "V2 BPI (high to low)",
    "zh-TW": "依V2 BPI由高到低",
    ko: "V2 BPI 높은 순",
  },
  "newBpi.tab.list": {
  ...
  "newBpi.listSummary.deltaHistogram": {
    ja: "差分(V2−V1)の分布",
    en: "Distribution of delta (V2 − V1)",
    "zh-TW": "差異(V2−V1)分佈",
    ko: "차이(V2−V1) 분포",
  },
  "newBpi.listSummary.bandDistribution": {
    ja: "BPI帯ごとの分布(V1 vs V2)",
    en: "Song count by BPI band (V1 vs V2)",
    "zh-TW": "各BPI區間的樂曲數（V1 vs V2）",
    ko: "BPI 구간별 곡 수(V1 vs V2)",
  },
  "newBpi.chart.xLabel": {
    ja: "EXスコア",
    en: "EX Score",
  ...
  "newBpi.chart.tableTitle": {
    ja: "スコアレート別 V1 BPI・V2 BPI",
    en: "V1 vs V2 BPI by Score Rate",
    "zh-TW": "各分數率的V1 BPI・V2 BPI",
    ko: "스코어레이트별 V1 BPI・V2 BPI",
  },
