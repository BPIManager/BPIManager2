export const newBpiTranslations = {
  ...
  "newBpi.notice.issueLink": {
    ja: "設計と経緯（GitHub #309）",
    en: "Design & history (GitHub #309)",
    "zh-TW": "設計與經緯（GitHub #309）",
    ko: "설계와 경위 (GitHub #309)",
  },
  ...
  "newBpi.params.z0.hint": {
    ja: "新方式のBPI0アンカー。曲ごとではなく、アリーナA帯在籍者（a1〜a5）の潜在能力 a_i の中央値を全曲共通の定数として使います（実測 ≈ -0.193）。以前の「皆伝平均のz位置」からアンカーの母集団を変更したもので、皆伝平均とは無関係です。",
    en: "The new formula's BPI-0 anchor. Instead of a per-song value, it uses the median latent ability (a_i) of Arena class-A players (a1–a5) as a single global constant (measured ≈ -0.193). The anchor population was changed from the earlier “Kaiden-average z position”, so it is unrelated to the Kaiden average.",
    "zh-TW": "新公式的BPI0錨點。並非逐曲，而是採用競技場A段位玩家（a1〜a5）潛在能力 a_i 的中位數作為全曲共通常數（實測 ≈ -0.193）。錨點母體已從先前的「皆傳平均 z 位置」變更，與皆傳平均無關。",
    ko: "신규 방식의 BPI0 기준점. 곡별 값이 아니라 아레나 A대(a1~a5) 재적자의 잠재 능력 a_i 중앙값을 전곡 공통 상수로 사용합니다(실측 ≈ -0.193). 기준점 모집단을 이전의 '황단 평균 z 위치'에서 변경한 것으로, 황단 평균과는 무관합니다.",
  },
};
