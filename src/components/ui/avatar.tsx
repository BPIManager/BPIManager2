  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        ...
        "bg-bpim-surface-2 text-sm text-bpim-muted",
  ...
  return (
    <span
      ...
      className={cn(
        ...
        "bg-bpim-primary text-bpim-text ring-2 ring-background select-none",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-bpim-surface-2 text-sm text-bpim-muted ring-2 ring-background",
