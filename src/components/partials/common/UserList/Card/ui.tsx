...
const UserRecommendationCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex h-25 w-25 shrink-0 self-center items-center justify-center rounded-xl border border-bpim-border bg-bpim-bg/40 p-1 sm:h-30 sm:w-30 md:h-35 md:w-35">
        <RadarSectionChart
          data={viewerRadar}
