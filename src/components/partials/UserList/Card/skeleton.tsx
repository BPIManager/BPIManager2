...
export const UserRecommendationCardSkeleton = () => {
  return (
    <div className="flex min-h-[140px] w-full items-stretch justify-between gap-3 rounded-2xl border border-white/10 bg-slate-900/40 p-3 md:min-h-[180px] md:gap-6 md:p-5">
