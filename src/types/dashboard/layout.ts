...
> = {
  ...
  rankDistribution: {
    label: "widget.rankDistribution",
    defaultWidth: "half",
    defaultSection: "main",
  },
  bpiDistribution: {
    label: "widget.bpiDistribution",
    defaultWidth: "half",
    defaultSection: "main",
  },
  bpmBpiDistribution: {
    label: "widget.bpmBpiDistribution",
    defaultWidth: "full",
    defaultSection: "main",
  },
  bpiHistory: {
    label: "widget.bpiHistory",
    defaultWidth: "full",
    defaultSection: "main",
  },
  bpiBoxStats: {
    label: "widget.bpiBoxStats",
    defaultWidth: "full",
    defaultSection: "main",
  },
  rivalWinLoss: {
    label: "widget.rivalWinLoss",
    defaultWidth: "full",
    defaultSection: "main",
  },
  radar: {
  ...
  iidxTower: {
    label: "widget.iidxTower",
    defaultWidth: "full",
    defaultSection: "sidebar",
  },
  officialArenaHistory: {
    label: "widget.officialArenaHistory",
    defaultWidth: "full",
    defaultSection: "sidebar",
  },
  rankingTabs: {
